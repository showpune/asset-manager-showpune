...
@Profile("!dev") // Active when not in dev profile (replaces S3 service)
public class AzureBlobStorageService implements StorageService {
    ...
    public void uploadObject(MultipartFile file) throws IOException {
        ...
        metadata.setS3Key(key); // Keep field name for compatibility
        metadata.setS3Url(generateUrl(key)); // Keep field name for compatibility
