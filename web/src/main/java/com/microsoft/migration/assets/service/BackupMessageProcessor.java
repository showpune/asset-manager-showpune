...
public class BackupMessageProcessor {
     ...
     * Uses Azure Service Bus API pattern similar to the worker module.
     */
    ...
    public void processBackupMessage(ImageProcessingMessage message) {
        try {
            ...
            // Service Bus will handle retry automatically
            throw e; // Re-throw to trigger Service Bus retry mechanism
        }
    }
}