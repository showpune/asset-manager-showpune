...
public class AzureStorageService implements StorageService {
        ...
        return containerClient.listBlobs().stream()
                .map(blobItem -> {
                    ...
                    Instant uploadedAt = imageMetadataRepository.findAll().stream()
                            .filter(metadata -> metadata.getBlobKey() != null && metadata.getBlobKey().equals(blobItem.getName()))
    ...
    public void deleteObject(String key) throws IOException {
        ...
        try {
            ...
            BlobClient thumbnailBlobClient = getContainerClient().getBlobClient(getThumbnailKey(key));
        ...
        imageMetadataRepository.findAll().stream()
                .filter(metadata -> metadata.getBlobKey() != null && metadata.getBlobKey().equals(key))
                .findFirst()
