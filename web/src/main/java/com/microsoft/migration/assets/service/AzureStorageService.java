...
@Profile("azure") // Active when azure profile is set
public class AzureStorageService implements StorageService {
    ...
    public void uploadObject(MultipartFile file) throws IOException {
        ...
        metadata.setS3Key(key); // Keep using S3Key field name for backward compatibility
        metadata.setS3Url(generateUrl(key)); // Keep using S3Url field name for backward compatibility
