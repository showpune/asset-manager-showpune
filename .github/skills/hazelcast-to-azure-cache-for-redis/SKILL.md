---
name: hazelcast-to-azure-cache-for-redis
description: Migrate from Hazelcast distributed cache to Azure Cache for Redis.
---

# hazelcast-to-azure-cache-for-redis

## Overview

Migrate from Hazelcast distributed cache to Azure Cache for Redis.

## Knowledge Base Content

* KB ID: hazelcast-to-azure-cache-for-redis
* Title: Migrate Hazelcast to Azure Cache for Redis
* Description: Provides specifications for migrating from Hazelcast to Azure Cache for Redis
* Content: 
## Requirements:
