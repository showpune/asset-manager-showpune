---
name: memcached-to-azure-cache-for-redis
description: Migrate from Memcached distributed cache to Azure Cache for Redis.
---

# memcached-to-azure-cache-for-redis

## Overview

Migrate from Memcached distributed cache to Azure Cache for Redis.

## Knowledge Base Content

* KB ID: memcached-to-azure-cache-for-redis
* Title: Migrate Memcached to Azure Cache for Redis
* Description: Provides specifications for migrating from Memcached to Azure Cache for Redis
* Content: 
## Requirements:
