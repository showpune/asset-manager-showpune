---
name: jcache-to-azure-cache-for-redis
...
Migrate from JCache (JSR-107) to Azure Cache for Redis for a scalable, managed solution that easily integrates with other Azure services.

## Knowledge Base Content

* KB ID: jcache-to-azure-cache-for-redis
* Title: JCache to Azure Cache for Redis
* Description: Provides specifications for migrating from JCache to Azure Cache for Redis
* Content: 
## Requirements:
