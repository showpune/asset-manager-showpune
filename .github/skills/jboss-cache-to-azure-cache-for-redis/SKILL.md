---
name: jboss-cache-to-azure-cache-for-redis
description: Migrate from JBoss Cache to Azure Cache for Redis.
---

# jboss-cache-to-azure-cache-for-redis

## Overview

Migrate from JBoss Cache to Azure Cache for Redis.

## Knowledge Base Content

* KB ID: jboss-cache-to-azure-cache-for-redis
* Title: Migrate Jboss Cache to Azure Cache for Redis
* Description: Migrate Jboss Cache to Azure Cache for Redis
* Content: 
## Requirements:
