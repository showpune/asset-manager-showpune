...
3. Custom agent usage to complete the coding task:
    1) Call custom agent appmod-java-upgrade-code-developer for upgrade task of java, include java-version-upgrade, spring-boot-upgrade, spring-framework-upgrade and jakarta-ee-upgrade
    ...
    2) Call custom agent appmod-migration-code-developer for transform task of to migrate from X to Y with skill name, you must call the custom agent with prompt with below information
