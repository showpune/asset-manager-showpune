---
name: mi-mysql-azure-sdk-public-cloud
...
Migrate from MySQL to Azure Database for MySQL with Azure SDK and managed identity for secure, credential-free authentication.

## Knowledge Base Content

* KB ID: microsoft://security-tasks/secure-azure-mysql-with-managed-identity/mi-mysql-azure-sdk-public-cloud/db-connection.formula
