---
name: embedded-cache-to-azure-cache-for-redis
...
Migrate from embedded cache to Azure Cache for Redis for a scalable, managed solution that easily integrates with other Azure services.

## Knowledge Base Content

* KB ID: embedded-cache-to-azure-cache-for-redis
* Title: Embedded Cache to Azure Cache for Redis
* Description: Provides specifications for migrating from Embedded Cache to Azure Cache for Redis
* Content: 
## Requirements:
