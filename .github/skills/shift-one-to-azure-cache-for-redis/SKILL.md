---
name: shift-one-to-azure-cache-for-redis
...
Migrate from ShiftOne in-process cache to Azure Cache for Redis.

## Knowledge Base Content

* KB ID: shift-one-to-azure-cache-for-redis
* Title: Migrate ShiftOne to Azure Cache for Redis
* Description: Provides specifications for migrating from ShiftOne to Azure Cache for Redis
* Content: 
## Requirements:
