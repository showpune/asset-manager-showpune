---
name: oracle-coherence-to-azure-cache-for-redis
description: Migrate from Oracle Coherence distributed cache to Azure Cache for Redis.
---

# oracle-coherence-to-azure-cache-for-redis

## Overview

Migrate from Oracle Coherence distributed cache to Azure Cache for Redis.

## Knowledge Base Content

* KB ID: oracle-coherence-to-azure-cache-for-redis
* Title: Migrate Oracle Coherence to Azure Cache for Redis
* Description: Provides specifications for migrating from Oracle Coherence to Azure Cache for Redis
* Content: 
## Requirements:
