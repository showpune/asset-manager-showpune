---
name: oscache-to-azure-cache-for-redis
...
Migrate from OSCache in-process cache to Azure Cache for Redis.

## Knowledge Base Content

* KB ID: oscache-to-azure-cache-for-redis
* Title: Migrate OSCache to Azure Cache for Redis
* Description: Provides specifications for migrating from OSCache to Azure Cache for Redis
* Content: 
## Requirements:
