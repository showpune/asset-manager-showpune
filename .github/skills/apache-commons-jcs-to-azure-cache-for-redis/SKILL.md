---
name: apache-commons-jcs-to-azure-cache-for-redis
...
Migrate from Apache Commons JCS in-process cache to Azure Cache for Redis.

## Knowledge Base Content

* KB ID: apache-commons-jcs-to-azure-cache-for-redis
* Title: Migrate Apache Commons JCS to Azure Cache for Redis
* Description: Provides specifications for migrating from Apache Commons JCS to Azure Cache for Redis
* Content: 
## Requirements:
