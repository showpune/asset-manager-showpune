---
name: apache-ignite-to-azure-cache-redis
description: Migrate from Apache Ignite distributed cache to Azure Cache for Redis.
---

# apache-ignite-to-azure-cache-redis

## Overview

Migrate from Apache Ignite distributed cache to Azure Cache for Redis.

## Knowledge Base Content

* KB ID: apache-ignite-to-azure-cache-redis
* Title: Migrate Apache Ignite to Azure Cache for Redis
* Description: Migrate from Apache Ignite to Azure Cache for Redis
* Content: 
## Requirements:
